...
Experiment 2 replicates Experiment 1 and tests a second prediction of noisy channel processing: As speech becomes noisier, children should rely more on their expectations.
...
Noisy channel principles provide a framework for understanding language processing in both adults and children. Within this framework, processing is characterized by the interaction of two models: one of perception, and one of expectation. What is the content of these models? One possibility is that they are models of speakers; that linguistic communication is pragmatic all the way down. Alternatively, these models could be linguistic in content, about the distributions of words, referents, and their mutual predictability. We hope our paradigm will be a tool for resolving this fundamental tension.
