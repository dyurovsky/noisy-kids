...
Outside of the domain of language, even school-aged children sometimes fail to combine cues across modalities or information sources \cite{}. For example, \citeA{nardini2010} showed that ... . Thus, children's successful use of independent information---for example, about high-level expectations for a speaker \cote{graham2014,matthews2010} or their reliability \cite{pasquini2008}---does not guarantee that they can integrate such information with perceptual uncertainty. Our current experiments were designed to test this hypothesis.
