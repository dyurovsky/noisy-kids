...
The noisy channel framework thus offers a route to understanding children's language processing, as well as its development. Within this framework, processing is characterized by the interaction of two models: one of perception, and one of expectation. The content of these models, however, is an outstanding question. One possibility is that expectations are fundamentally about speakers, and that linguistic communication is pragmatic all the way down. Alternatively, these models could be linguistic in content, about the distributions of words, referents, and their mutual predictability. We hope our paradigm will be a tool for resolving this fundamental tension.

\section{Acknowledgments}

We thank Nicolette Castro for data collection, NIH NRSA F32HD075577 to DY and a John Merck Scholars Fellowship to MCF.
