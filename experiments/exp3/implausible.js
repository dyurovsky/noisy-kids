...
makeWordList = function(order, trainPermutation, testPermutation) {
	...
	var testWords = shuffleByPermutation(
		["shirt_die", "coats_horses", "fan_airport", "paper_pan", 
		"beach_bowl", "worms_bags", "marker_cup", "carrots_bees"],
		testPermutation);
...
playPrompt = function(word) {
	...
	handler = function() {
	    if (this.currentTime >= spriteData[word].start + spriteData[word].length + .1) {
	        this.pause();
	    }
	};
...
var testImages = [["shirt_tie", "shirt_die"], ["goats_horses", "coats_horses"],
 ["van_airport", "fan_airport"], ["paper_pen", "paper_pan"], ["beach_ball", "beach_bowl"], 
 ["worms_bugs", "worms_bags"], ["marker_cap", "marker_cup"], ["carrots_peas", "carrots_bees"]];
